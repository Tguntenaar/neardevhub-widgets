...
const postSearchKeywords = props.searchKeywords ? (
  <div style={{ "font-family": "monospace" }} key="post-search-keywords">
    ...
    {props.searchKeywords.map((tag) => (
      <Widget
        src={`${nearDevGovGigsWidgetsAccountId}/widget/DevHub.components.atom.Tag`}
    ...
    <small class="text-muted">
      <div class="row justify-content-between">
        <div class="col-4">
          ...
          <Widget
            src={`${nearDevGovGigsWidgetsAccountId}/widget/DevHub.components.molecule.ProfileCard`}
            props={{
              accountId: post.author_id,
            }}
          />
...
const CreatorWidget = (postType) => {
  return (
    ...
    >
      ...
      <Widget
        src={`${nearDevGovGigsWidgetsAccountId}/widget/DevHub.entity.post.PostEditor`}
        props={{
          postType,
          onDraftStateChange: props.onDraftStateChange,
          draftState:
