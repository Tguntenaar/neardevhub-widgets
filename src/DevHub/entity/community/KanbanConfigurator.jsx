const { permissions, handle, community, nearDevGovGigsWidgetsAccountId } =
  props;
...
const KanbanViewConfigurator = ({ communityHandle, link, permissions }) => {
      ...
      <div className="d-flex flex-column flex-lg-row align-items-stretch gap-4 w-100">
        <div className="d-flex flex-column gap-4 w-100">
          ...
          <Widget
            ...
            props={{
              ...
              Configurator: () => (
                <Widget
                  src={`${nearDevGovGigsWidgetsAccountId}/widget/DevHub.entity.community.KanbanPostBoardBasicInfoConfigurator`}
                  props={{
                    data: community,
          ...
          <Widget
            ...
            props={{
              ...
              Configurator: () => (
                <Widget
                  src={`${nearDevGovGigsWidgetsAccountId}/widget/DevHub.entity.community.KanbanPostBoardTagsSchemaConfigurator`}
                  props={{
                    data: community,
                    onSubmit: (v) => console.log(v),
                    nearDevGovGigsWidgetsAccountId,
        ...
        <Widget
          ...
          props={{
            ...
            Configurator: () => (
              <Widget
                src={`${nearDevGovGigsWidgetsAccountId}/widget/DevHub.entity.community.KanbanPostBoardTicketFeaturesSchemaConfigurator`}
                props={{
                  data: community,
                  onSubmit: (v) => console.log(v),
                  nearDevGovGigsWidgetsAccountId,
  ...
  return !isViewInitialized && community.data === null ? (
    ...
    >
      ...
      {isViewInitialized ? (
        <Widget
          src={`${nearDevGovGigsWidgetsAccountId}/widget/gigs-board.entity.workspace.view.${form.values.metadata.type}`}
          props={{
            ...form.values,
